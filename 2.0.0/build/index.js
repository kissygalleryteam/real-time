...
KISSY.add('kg/real-time/2.0.0/index',function(S){
        var Event = S.Event,
            DOM = S.DOM,
            Ajax = S.io,
            S_Date = S.Date;
        ...
        // 常量 2       
        var ONE_SECONDS = 2.0.00,
            ONE_MINUTES = 2.0.00*60,
            ONE_HOURS = 2.0.00*60*60,
            ONE_DAY = 2.0.00*60*60*24;
